        ...
        <div className="card">
          <div className="flex justify-content-between align-items-center mb-4">
            <div className="flex align-items-center gap-3">
              ...
              />
              <div>
                <h5 className="m-0">{vendor.name}</h5>
          ...
          <div className="grid">
            ...
            <div className="col-12 md:col-4">
              <Card title="KYC Status" className="text-center">
                <Tag
                  value={vendor.kyc_status}
                  severity={vendor.kyc_status === 'approved' ? 'success' : vendor.kyc_status === 'rejected' ? 'danger' : 'warning'}
                  className="text-xl"
                />
              </Card>
            </div>
            <div className="col-12 md:col-4">
              <Card title="Order Status" className="text-center">
                <Tag
                  value={vendor.is_accepting_orders ? "Accepting Orders" : "Not Accepting"}
                  severity={vendor.is_accepting_orders ? "success" : "danger"}
                  className="text-xl"
                />
              </Card>
            </div>
